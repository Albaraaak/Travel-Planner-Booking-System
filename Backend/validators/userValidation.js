...
const insertUserValidation = [
  ...
  check("password")
    ...
    .isStrongPassword()
    .withMessage(
      "Use a combination of lowercase, uppercase, numbers, and special characters for your password"
    ),
  ...
  check("phoneNumber")
    .matches(/^\+?[1-9]\d{1,14}$/)
    .withMessage(
      "Invalid phone number format. Use the international format, e.g., +1234567890"
    ),
];
